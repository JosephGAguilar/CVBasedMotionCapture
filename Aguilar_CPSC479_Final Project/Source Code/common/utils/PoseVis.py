...
def p_vis_keypoints(img, kps, kps_lines, kp_thresh=0.4, alpha=1):
...
def p_vis_3d_skeleton(kpt_3d, kpt_3d_vis, kps_lines, filename=None, output_path='3d_skeleton.png'):
...
def p_vis_3d_multiple_skeleton(kpt_3d, kpt_3d_vis, kps_lines, filename=None, output_path='3d_multiple_skeleton.png'):
